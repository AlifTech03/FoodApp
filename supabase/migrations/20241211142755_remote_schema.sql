...
CREATE POLICY "allow authenticated user" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "order item policy" ON "public"."order_item" USING (true) WITH CHECK (true);
...
CREATE POLICY "orders policy" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
